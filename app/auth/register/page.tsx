    ...
    return (
        <div className="bg-black min-h-screen text-white flex flex-col lg:flex-row-reverse overflow-x-hidden" dir="ltr">
            ...
            <div className="lg:w-1/2 min-h-[35vh] lg:min-h-screen p-8 md:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-l border-white/5 relative overflow-hidden bg-zinc-950">
                <div className="absolute bottom-0 right-0 w-full h-full bg-emerald-600/5 blur-[120px] pointer-events-none" />
                
                <Link href="/" className="text-xl md:text-2xl font-black tracking-tighter uppercase relative z-10 hover:text-emerald-500 transition-colors">
                    Arka.
                </Link>
                    ...
                    <form className="space-y-5">
                        ...
                        <div className="group space-y-2">
                            ...
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-700 group-focus-within:text-emerald-500 transition-colors w-[18px] h-[18px]" />
                                <input 
                                    type="text" 
                                    placeholder="JOHN DOE" 
                                    className="w-full bg-zinc-900/50 border border-white/5 rounded-2xl py-4 pl-12 pr-4 outline-none focus:border-emerald-600 focus:bg-transparent transition-all font-bold text-sm placeholder:text-zinc-800" 
                                />
                            </div>
                        </div>
                        ...
                        <div className="group space-y-2">
                            ...
                            <div className="relative">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-700 group-focus-within:text-emerald-500 transition-colors w-[18px] h-[18px]" />
                                <input 
                                    type="email" 
                        ...
                        <div className="group space-y-2">
                            ...
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-700 group-focus-within:text-emerald-500 transition-colors w-[18px] h-[18px]" />
                                <input 
                                    type="password" 
                        ...
                        <button className="w-full py-4 md:py-5 bg-white text-black rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all transform active:scale-[0.98] flex items-center justify-center gap-3">
                            Confirm Registration <ArrowRight className="w-[18px] h-[18px]" />
                        </button>
                    </form>
